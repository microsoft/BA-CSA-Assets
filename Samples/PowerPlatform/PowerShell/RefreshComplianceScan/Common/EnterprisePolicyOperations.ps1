...
function PutEnterprisePolicy($resourceGroup, $body)
 {
    ...
    $policy = New-AzResourceGroupDeployment -DeploymentName "EPDeployment1" -ResourceGroupName $resourceGroup -TemplateFile $tmp.FullName
...
function RemoveEnterprisePolicy($subscriptionId, $policyArmId)
{
